...
class CP1610 : public Processor
{
    ...
    private:
        ...
        UINT16 JSR(UINT16 register, UINT16 target);
        UINT16 JE(UINT16 target);
        UINT16 JSRE(UINT16 register, UINT16 target);
        UINT16 JD(UINT16 target);
        UINT16 JSRD(UINT16 register, UINT16 target);
        UINT16 INCR(UINT16 register);
        UINT16 DECR(UINT16 register);
        UINT16 COMR(UINT16 register);
        UINT16 NEGR(UINT16 register);
        UINT16 ADCR(UINT16 register);
        UINT16 RSWD(UINT16 register);
        UINT16 GSWD(UINT16 register);
        UINT16 NOP(UINT16 twoOption);
        UINT16 SIN(UINT16 twoOption);
        UINT16 SWAP_1(UINT16 register);
        UINT16 SWAP_2(UINT16 register);
        UINT16 SLL_1(UINT16 register);
        UINT16 SLL_2(UINT16 register);
        UINT16 RLC_1(UINT16 register);
        UINT16 RLC_2(UINT16 register);
        UINT16 SLLC_1(UINT16 register);
        UINT16 SLLC_2(UINT16 register);
        UINT16 SLR_1(UINT16 register);
        UINT16 SLR_2(UINT16 register);
        UINT16 SAR_1(UINT16 register);
        UINT16 SAR_2(UINT16 register);
        UINT16 RRC_1(UINT16 register);
        UINT16 RRC_2(UINT16 register);
        UINT16 SARC_1(UINT16 register);
        UINT16 SARC_2(UINT16 register);
