 ...
 * Custom Overlay Support. See the 'overlay-library.zip' in the Extras folder on github for details.
...
A large number of custom overlays are provided in **overlay-library.zip** in the extras folder here on the github site. Nintellivision should automatically match up the game you are playing
